...
from okex.okexAPI.rest.HttpMD5Util import buildMySign, httpGet, httpPost
...
class OKCoinSpot:
    ...
    #获取OKCOIN现货行情信息
    def ticker(self, symbol, *args, **kwargs):
    ...
    #获取OKCOIN现货市场深度信息
    def depth(self, symbol, *args, **kwargs):
    ...
    #获取OKCOIN现货历史交易信息
    def trades(self, symbol, since='', *args, **kwargs):
    ...
    #获取OKCOIN现货K线数据
    def kline(self, symbol, period, size='', since='', *args, **kwargs):
